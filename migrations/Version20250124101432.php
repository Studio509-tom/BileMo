 ...
 */
final class Version20250124101432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64975A281C7 FOREIGN KEY (reference_customer_id) REFERENCES customer (id)');
